...
<head>
    ...
    <title>Service Records | {{ config('app.name', 'Fleet Manager') }}</title>
        ...
        <div class="container px-4 px-lg-5">
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <h3 class="stat-value mb-0">{{ $totalServices }}</h3>
                            </div>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <h3 class="stat-value text-success mb-0">Tsh {{ number_format($totalCost/1000000, 1) }}M</h3>
                            </div>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <h3 class="stat-value text-warning mb-0">{{ $thisMonthServices }}</h3>
                            </div>
                    ...
                    <div class="stat-card">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <h3 class="stat-value text-info mb-0">Tsh {{ number_format($avgCost, 0) }}</h3>
                            </div>
                            <div class="stat-icon" style="background: linear-gradient(135deg, #dbeafe, #bfdbfe);">
            ...
            <div class="modern-card">
                    ...
                    <div class="table-responsive">
                        <table class="modern-table table">
                            ...
                            <tbody id="tableBody">
                                ...
                                <tr class="service-row" onclick="viewService({{ $service->id }})">
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <div class="fw-semibold">{{ $service->motorbike->model ?? 'N/A' }}</div>
                                                <div class="small text-muted">
                                                    <i class="fas fa-tag me-1"></i>{{ $service->motorbike->plate_number ?? 'No Plate' }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div class="contract-badge">
                                            ...
                                            #{{ str_pad($service->contract->id, 4, '0', STR_PAD_LEFT) }}
                                        </div>
                                        @else
                                    ...
                                    <td>
                                        <div class="cost-badge">
                                            ...
                                            Tsh {{ number_format($service->cost, 0) }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="date-info">
                                            ...
                                            <div class="date-details">
                                                <div class="date">{{ \Carbon\Carbon::parse($service->service_date)->format('M d, Y') }}</div>
                                                <div class="time-ago">{{ \Carbon\Carbon::parse($service->service_date)->diffForHumans() }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-end" onclick="event.stopPropagation()">
                                        <div class="action-group">
                                            <a href="{{ route('services.index', $service->id) }}" class="action-btn view" title="View Details">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('services.edit', $service->id) }}" class="action-btn edit" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button onclick="deleteService({{ $service->id }})" class="action-btn delete" title="Delete">
                ...
                <div class="pagination-modern">
                    ...
                    @else
                    <a href="{{ $services->previousPageUrl() }}" class="page-link-modern">
                        <i class="fas fa-chevron-left"></i>
                    </a>
                    @endif
                    ...
                    @foreach(range(1, $services->lastPage()) as $i)
                        @if($i >= $services->currentPage() - 2 && $i <= $services->currentPage() + 2)
                            ...
                            @else
                            <a href="{{ $services->url($i) }}" class="page-link-modern">{{ $i }}</a>
                            @endif
                        @endif
                    @endforeach

                    @if($services->hasMorePages())
                    <a href="{{ $services->nextPageUrl() }}" class="page-link-modern">
                ...
                <div class="col-md-6">
                    <div class="bg-white rounded-4 p-3 d-flex align-items-center gap-3 shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="fw-bold">{{ $totalServices > 0 ? round($totalServices / max(1, \Carbon\Carbon::parse($services->min('service_date') ?? now())->diffInMonths(now())), 1) : 0 }} services/month</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="bg-white rounded-4 p-3 d-flex align-items-center gap-3 shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="fw-bold">{{ $totalServices > 0 ? 'Tsh ' . number_format($totalCost / $totalServices, 0) : 'Tsh 0' }} per service</div>
                        </div>
                    </div>
                </div>
            </div>
